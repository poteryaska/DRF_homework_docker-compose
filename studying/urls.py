...
urlpatterns = [
    ...
    path('subscription/<int:pk>/', SubscriptionCreateAPIView.as_view(), name='subscribtion-create'),
    path('subscription/delete/<int:pk>/', SubscriptionDestroyAPIView.as_view(), name='subscribtion-delete')
] + router.urls